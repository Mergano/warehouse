...
public class RuntimeUtil {
    ...
    /**
     * Redirects given process's input and error streams to the specified
     * streams. the streams specified are not closed automatically. The streams
     * passed can be null, if you don't want to redirect them.
     *
     * @param process process whose streams to be redirected
     * @param output outputStream to which process's inputStream is
     * redirected.<br>
     * null if you don't want to redirect.
     * @param error outputStream to which process's errorStream is
     * redirected.<br>
     * null if you don't want to redirect.
     */
    ...
    /*-------------------------------------------------[ Terminal Command ]---------------------------------------------------*/
    /**
     * Runs the specified <code>command</code> in terminal (sh in *nix/cmd in
     ...
     * variable settings in the format
     * <i>name</i>=<i>value</i>, or
     * <tt>null</tt> if the subprocess should inherit the environment of the
     * current process.
     *
     * @param workingDir the working directory of the subprocess, or
     * <tt>null</tt> if the subprocess should inherit the working directory of
     * the current process.
     *
    ...
    /**
     * Runs the specified <code>command</code> in terminal (sh in *nix/cmd in
     * windows) and returns the command output. The subprocess created inherits
     * environment and working directory from the current process
     *
     * @param command complete command to be executed
     * @return output of the command.
     *
    ...
    /*-------------------------------------------------[ PID ]---------------------------------------------------*/
    /**
     * Returns the PID of the current process. The PID will also be saved in
     * system property <code>"pid"</code>
     *
    ...
    /**
     * This method guarantees that garbage collection is done after JVM shutdown
     * is initialized
     */
